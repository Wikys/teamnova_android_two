package com.example.teamnova_android_two.Google_API;
...
//
//        map.animateCamera(CameraUpdateFactory.newLatLngZoom(seoul, 10));
        mMap = googleMap;
        ...
        if(hasFineLocationPermission == PackageManager.PERMISSION_GRANTED&&
            ...
            //2. 퍼미션 요청을 허용한 적이 없다면 퍼미션 요청이 필요 2가지 경우(3-1, 4-1)가 있음
